...
def drawMenu(tela,dimensoes,escala):
    ...
    titulo = titleFonte("S.O.E.E.", True, "WHITE") # "KWIA ?"
    subtitulo = textFont("Sabe onde eu estou ?", True, "WHITE") # "(Know Where I Are?)"
    ...
    tela.blit(titleFonte("Play Game", True, "WHITE"), ( 
